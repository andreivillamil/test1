...
<div class="main-table-frame">
	<div class="main-table-frame-dark">
		<div class="main-table-frame-first-bar" colspan="2">
			<img src="images/coykillericon-50-38.png"/>
			OWASP Mutillidae II: Keep Calm and Pwn On
		</div>
	</div>
	<div class="main-table-frame-dark">
		<div class="main-table-frame-second-bar" colspan="2">
	...
	<div class="main-table-frame-menu-bar">
		<!-- <ul class="main-table-frame-menu-bar" colspan="2">
			<li class="current"><a href="index.php?page=home.php&popUpNotificationCode=HPH0">Home</a></li>
			|
			<?php
				if ($_SESSION['loggedin'] == 'True'){
					echo '<li class"Logout"><a href="index.php?do=logout">Logout</a></li>';
				} else {
					echo '<li class"Login"><a href="index.php?page=login.php">Login/Register</a></li>';
				}// end if
			?>
			|
			<?php
			...
			?>
			<li class="Toggle"><a href="index.php?do=toggle-security&page=<?php echo $lPage?>">Toggle Security</a></li>
			|
			<li class="Enforce"><a href="index.php?do=toggle-enforce-ssl&page=<?php echo $lPage?>"><?php echo $lEnforceSSLLabel; ?></a></li>
			|
			<li class="Reset"><a href="set-up-database.php">Reset DB</a></li>
			|
			<li class="View"><a href="index.php?page=show-log.php">View Log</a></li>
			|
			<li class="Viewc"><a href="index.php?page=captured-data.php">View Captured Data</a></li>
		</ul> -->
	</div>
	<tr>
